...
@Composable
fun UnimportantScreen(navController : NavController) {
    Column(modifier = Modifier.fillMaxSize()) {
        // Section d'entête (non défilable)
        HeaderUnimportantSection()
        // Section des messages (défilable)
        MessageListUnimportantSection()

        // Section de la barre de navigation
        BottomNavigationBarUnimportant()
    }
}

@Composable
fun HeaderUnimportantSection() {
    Box(
        modifier = Modifier
            .fillMaxWidth()
            .height(360.dp)
            .background(Color(0xFFBA3939)) // Fond vert
    ) {
        Row(
            modifier = Modifier
                .fillMaxWidth()
        ...
        // Image centrée
        Image(
            painter = painterResource(com.jaures.smartmail.R.drawable.unimportant),
            contentDescription = null,
            modifier = Modifier
                .size(86.dp, 88.17.dp)
...
@Composable
fun MessageListUnimportantSection() {
    LazyColumn(
        modifier = Modifier
            .fillMaxWidth()
...
@Composable
fun BottomNavigationBarUnimportant() {
...
@Composable
fun MessageItemUnimportant(name: String, subject: String, message: String, date: String, isFavorite: Boolean) {
    Row(
        modifier = Modifier
            .fillMaxWidth()
            .height(92.dp)
