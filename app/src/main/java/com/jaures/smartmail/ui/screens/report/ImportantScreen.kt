...
fun HeaderSection() {
    Box(
        modifier = Modifier
            .fillMaxWidth()
            .height(360.dp)
            .background(Color(0xFF81C784)) // Fond vert
    ) {
        Row(
            modifier = Modifier
                .fillMaxWidth()
        ...
        // Image centrée
        Image(
            painter = painterResource(com.jaures.smartmail.R.drawable.important),
            contentDescription = null,
            modifier = Modifier
                .size(86.dp, 88.17.dp)
...
@Composable
fun MessageItem(name: String, subject: String, message: String, date: String, isFavorite: Boolean) {
    Row(
        modifier = Modifier
            .fillMaxWidth()
            .height(92.dp)
